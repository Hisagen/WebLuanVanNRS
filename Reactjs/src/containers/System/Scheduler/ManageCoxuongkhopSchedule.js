...
class ManageCoxuongkhopSchedule extends Component {
  constructor(props) {
    super(props);
    this.state = {
      listDoctors: [],
  ...
  componentDidMount() {
    this.props.fetchAllVienchucChuyenkhoaCoxuongkhop();
    this.props.fetchAllBuoi();
    this.props.fetchAllPhongChuyenkhoaCoxuongkhop();
    this.hamdata();
  }
  ...
  hamdata = async () => {
    {
      let mang1 = await getAllChuyenkhoaLichbacsikhamService(23);
      let tam = [];
      let tam2 = "";
      let giobd = "";
      let giokt = "";
...
const mapStateToProps = (state) => {
  return {
    ...
    allDoctors: state.admin.vienchucchuyenkhoacoxuongkhops,
    allScheduleTime: state.admin.buois,
    allPhongs: state.admin.phongchuyenkhoacoxuongkhops,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    fetchAllVienchucChuyenkhoaCoxuongkhop: () =>
      dispatch(actions.fetchVienchucChuyenkhoaCoxuongkhopStart()),
    fetchAllBuoi: () => dispatch(actions.fetchAllBuoiStart()),
    fetchAllPhongChuyenkhoaCoxuongkhop: () =>
      dispatch(actions.fetchAllPhongChuyenkhoaCoxuongkhopStart()),
  };
};
